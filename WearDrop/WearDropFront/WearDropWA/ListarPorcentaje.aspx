        ...
        <div class="container row">
            <div class="row align-items-center">
                ...
                <div class="col text-end p-3">
                    ...
                    <asp:LinkButton ID="lkFiltrar" CssClass="btn" Style="background-color:  #A0B4C5; color: #FFFFFF; border-color: #73866D" Visible="false" runat="server" OnClick="lkFiltrar_Click" Text="Filtrar" />
                </div>
            </div>
        </div>
        <div class="container row mt-4">
            ...
            <asp:GridView ID="gvPorcentajes" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Porcentaje Promocion" DataField="porcentaje"/>
