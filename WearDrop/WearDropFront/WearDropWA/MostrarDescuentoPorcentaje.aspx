<%@ Page Title="" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="MostrarDescuentoPorcentaje.aspx.cs" Inherits="WearDropWA.MostrarDescuentoPorcentaje" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Mostrar Descuento Porcentaje
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:TextBox ID="txtIdDescuento" runat="server" CssClass="form-control" placeholder="Placeholder text"></asp:TextBox>
        ...
        <!-- Ubicacion -->
        <div class="mb-4">
            <asp:Label ID="lbPorcentaje" runat="server" Text="Porcentaje " CssClass="form-label"></asp:Label>
