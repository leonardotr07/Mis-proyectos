<%@ Page Title="Modificar Factura" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="ModificarFactura.aspx.cs" Inherits="WearDropWA.ModificarFactura" %>
        ...
        <div class="theme-scope">
            <div class="container">
                ...
                <div class="modal fade" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                La factura se modificó correctamente.
                            </div>
                            <div class="modal-footer">
                ...
                <div class="section-container">
                    <asp:UpdatePanel ID="upModificarFactura" runat="server">
                        <ContentTemplate>
                                ...
                                <div class="two-columns">
                                    ...
                                    <div class="field-block">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvCorrelativo" runat="server" 
                                            ...
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModFactura" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subsection">
                                <div class="two-columns">
                                    <div class="field-block">
                                        ...
                                        <asp:TextBox ID="txtFacturaRUC" runat="server" CssClass="form-control" MaxLength="11"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvRUC" runat="server" 
                                            ControlToValidate="txtFacturaRUC" ErrorMessage="El RUC es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModFactura" />
                                        <asp:RegularExpressionValidator ID="revRUC" runat="server"
                                            ControlToValidate="txtFacturaRUC" ValidationExpression="^\d{11}$"
                                    ...
                                    <div class="field-block">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvRazonSocial" runat="server" 
                                            ControlToValidate="txtFacturaRazonSocial" ErrorMessage="La razón social es obligatoria" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModFactura" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="two-columns">
                                    <div class="field-block">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvFechaFactura" runat="server" 
                                            ControlToValidate="txtFacturaFecha" ErrorMessage="La fecha es obligatoria" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModFactura" />
                                    </div>
                                    <div class="field-block">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvMetodoPago" runat="server" 
                                            ControlToValidate="txtFacturaMetodoPago" ErrorMessage="El método de pago es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModFactura" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subsection">
                                <div class="two-columns">
                                    <div class="field-block">
                                        <h3>Total (S/.) <span class="required">(*)</span></h3>
                                        <asp:TextBox ID="txtFacturaTotal" runat="server" CssClass="form-control" TextMode="Number" placeholder="0.00"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvTotal" runat="server" 
                                            ControlToValidate="txtFacturaTotal" ErrorMessage="El total es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModFactura" />
                                        <asp:RangeValidator ID="rvTotal" runat="server"
                                            ControlToValidate="txtFacturaTotal" Type="Double" MinimumValue="0.01" MaximumValue="9999999"
                                            ErrorMessage="El total debe ser un número mayor a 0." CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModFactura" />
                                    </div>
                                    <div class="field-block">
                                        <div class="igv-container">
                                            <h3>IGV (%): <span class="required">(*)</span></h3>
                                            <asp:TextBox ID="txtFacturaIGV" runat="server" CssClass="form-control igv-textbox"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvIGV" runat="server" 
                                                ControlToValidate="txtFacturaIGV" ErrorMessage="IGV obl." 
                                                CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModFactura" />
                                            <asp:RangeValidator ID="rvIGV" runat="server"
                                                ControlToValidate="txtFacturaIGV" Type="Double" MinimumValue="0" MaximumValue="100"
                                                ErrorMessage="IGV entre 0-100." CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModFactura" />
                                        </div>
                                    </div>
                                </div>
                            </div>
