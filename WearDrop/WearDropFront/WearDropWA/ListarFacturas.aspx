<%@ Page Title="Listar Facturas" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="ListarFacturas.aspx.cs" Inherits="WearDropWA.ListarFacturas" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="container">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col text-end p-3">
                            <asp:HyperLink ID="btnIrARegistrar" CssClass="btn-wd" 
                                runat="server" 
                                NavigateUrl="~/RegistrarFactura.aspx" 
                ...
                <div class="container row mt-3">
                    <asp:GridView ID="gvFacturas" runat="server" 
                        ...
                        EmptyDataText="No hay facturas disponibles"
                                ...
                                <ItemTemplate>
                                    <div class="action-btns">
                                        ...
                                        <asp:LinkButton ID="btnEliminar" runat="server" 
                                            ...
                                            CommandArgument='<%# Eval("idComprobante") %>'
                                            OnClientClick='<%# "return mostrarModalEliminar(" + Eval("idComprobante") + ", \"" + Eval("Correlativo") + "\", \"" + Eval("razonSocial") + "\");" %>'
                                            ToolTip="Eliminar">
    ...
    <div id="modalEliminarFactura" class="modal-overlay">
        <div class="modal-content-custom">
            <h3 class="modal-title">¿Está seguro de eliminar esta factura?</h3>
            <div class="modal-body">
                <div class="info-field">
                    <div class="info-label">Correlativo de la Factura:</div>
                    <div class="info-value" id="modalCorrelativo"></div>
                </div>
                <div class="info-field">
                    <div class="info-label">Razón Social:</div>
                    <div class="info-value" id="modalRazonSocial"></div>
                </div>
            ...
            <asp:HiddenField ID="hfIdFacturaEliminar" runat="server" />
        </div>
    </div>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptsContent" runat="server">
    <script type="text/javascript">
        function mostrarModalEliminar(idFactura, correlativo, razonSocial) {
            document.getElementById('modalCorrelativo').innerText = correlativo;
            document.getElementById('modalRazonSocial').innerText = razonSocial;
            document.getElementById('<%= hfIdFacturaEliminar.ClientID %>').value = idFactura;
        ...
        window.onclick = function (event) {
            var modal = document.getElementById('modalEliminarFactura');
