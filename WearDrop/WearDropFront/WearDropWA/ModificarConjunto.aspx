<%@ Page Title="" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="ModificarConjunto.aspx.cs" Inherits="WearDropWA.ModificarConjunto" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Modificar Promocion Conjunto
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="btnAñadirPrenda" runat="server" Text="Añadir Prenda" CssClass="btn-anadir-prenda" OnClick="btnAñadirPrenda_Click"/>
                ...
                <div class="mt-5 d-flex justify-content-between">
                    ...
                    <asp:Button ID="btnRegistrar" runat="server" Text="Modificar" CssClass="btn-registrar" OnClick="btnModificar_Click1"/>
                </div>
            </div>
        </div>
            </div>
