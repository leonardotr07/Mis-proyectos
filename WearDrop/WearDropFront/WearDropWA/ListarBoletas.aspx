<%@ Page Title="Listar Boletas" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="ListarBoletas.aspx.cs" Inherits="WearDropWA.ListarBoletas" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="theme-scope">
            <div class="container">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col text-end p-3">
                            <asp:HyperLink ID="btnIrARegistrar" CssClass="btn-wd" 
                                runat="server" 
                                NavigateUrl="~/RegistrarBoleta.aspx" 
                ...
                <div class="container row mt-3">
                    <asp:GridView ID="gvBoletas" runat="server" 
                        AutoGenerateColumns="False" 
                        ShowHeaderWhenEmpty="True"
                        EmptyDataText="No hay boletas disponibles"
                                ...
                                <ItemTemplate>
                                    <div class="action-btns">
                                        ...
                                        <asp:LinkButton ID="btnEliminar" runat="server" 
                                            ...
                                            CommandArgument='<%# Eval("idComprobante") %>'
                                            OnClientClick='<%# "return mostrarModalEliminar(" + Eval("idComprobante") + ", \"" + Eval("Correlativo") + "\");" %>'
                                            ToolTip="Eliminar">
    ...
    <div id="modalEliminarBoleta" class="modal-overlay">
        <div class="modal-content-custom">
            <h3 class="modal-title">¿Está seguro de eliminar esta boleta?</h3>
            <div class="modal-body">
                <div class="info-field">
                    <div class="info-label">Correlativo de la Boleta:</div>
            ...
            <asp:HiddenField ID="hfIdBoletaEliminar" runat="server" />
        </div>
    </div>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptsContent" runat="server">
    <script type="text/javascript">
        function mostrarModalEliminar(idBoleta, correlativo) {
            document.getElementById('modalCorrelativo').innerText = correlativo;
            document.getElementById('<%= hfIdBoletaEliminar.ClientID %>').value = idBoleta;
            document.getElementById('modalEliminarBoleta').style.display = 'flex';
            return false; // Evita postback hasta confirmar
        }

        function cerrarModalEliminar() {
            document.getElementById('modalEliminarBoleta').style.display = 'none';
        }

        // Cerrar modal si se hace clic fuera de él
        window.onclick = function (event) {
            var modal = document.getElementById('modalEliminarBoleta');
