...
<asp:Content ID="ctHead" ContentPlaceHolderID="HeadContent" runat="server">
    <style>
        ...
        .bar-1{background:#C5D9C0;flex:1.5}   /* verde claro */
        .bar-2{background:#95B88F;flex:1.5}   /* verde medio */
        ...
        .custom-grid th{
            background:#95B88F !important;  /* cabecera verde */
        ...
        .custom-grid tr:hover{background:#E8F4E5} /* hover verde muy claro */
        .action-btns i{font-size:1.05em}
        .btn-sm{padding:4px 8px !important;margin-right:6px}

        /* ===== Botones superiores ===== */
        .btn-solid{
            background:#73866D;color:#fff;border:none;padding:8px 18px;border-radius:10px;
            cursor:pointer;display:inline-block;transition:.15s;box-shadow:0 1px 2px rgba(0,0,0,.08);
            text-decoration:none!important
        }
        .btn-solid:hover{filter:brightness(.95)}
        .btn-ghost{
            background:#E9F0E8;color:#3b4a3b;border:1px solid #C7D6C5;padding:8px 18px;border-radius:10px;
            text-decoration:none!important
        }
    ...
    <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 p-0">
                    <div class="header-title">
                        <div class="title-section"><h2>Ventas Realizadas</h2></div>
                        <div class="color-bar bar-1"></div>
                        <div class="color-bar bar-2"></div>
                    </div>
                </div>
                <div class="col text-end p-3">
                    <asp:LinkButton ID="lkRegresar" runat="server" CssClass="btn-ghost no-underline me-2" OnClick="lkRegresar_Click">
                        Regresar
                    </asp:LinkButton>
                    <asp:LinkButton ID="lkFiltrar" runat="server" CssClass="btn-solid no-underline" OnClick="lkFiltrar_Click">
                        Filtrar
                    </asp:LinkButton>
                </div>
            </div>
        ...
        <div class="container row mt-3">
            <div class="col-md-3">
                ...
                <asp:TextBox ID="txtFiltroId" runat="server" CssClass="form-control" placeholder="X" />
            </div>
            <div class="col-md-9">
                <label class="form-label">Nombre</label>
                <asp:TextBox ID="txtFiltroNombre" runat="server" CssClass="form-control" placeholder="Placeholder text" />
            </div>
        </div>
