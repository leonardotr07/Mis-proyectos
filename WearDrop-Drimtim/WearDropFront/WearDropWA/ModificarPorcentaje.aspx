<%@ Page Title="" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="ModificarPorcentaje.aspx.cs" Inherits="WearDropWA.ModificarPorcentaje" %>
        ...
        <div class="row mt-5">
            <div class="col-md-8">
                ...
                <div class="mb-4">
                    ...
                    <asp:TextBox ID="txtNombrePor" runat="server" CssClass="form-control" placeholder="Placeholder text"></asp:TextBox>
