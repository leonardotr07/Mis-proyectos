    ...
    <div class="row row-gap col-lg-10">
      ...
      <div class="col-md-6">
        ...
        <asp:RegularExpressionValidator 
            ...
            ErrorMessage="Solo se permiten números y deben ser 9 dígitos" 
            CssClass="text-danger" 
            Display="Dynamic" 
            ValidationGroup="RegistrarCliente" />
      </div>
      ...
      <div class="col-md-6">
          <label for="ddlTipoCliente" class="form-label">Rol de Usuario</label>

          <asp:DropDownList ID="ddlTipoCliente" runat="server" CssClass="form-select"
              Style="height: 46px; border-radius: 10px;">
              <asp:ListItem Text="-- Seleccione --" Value=""></asp:ListItem>
              <asp:ListItem Text="Mayorista" Value="6"></asp:ListItem>
              <asp:ListItem Text="Minorista" Value="7"></asp:ListItem>
          </asp:DropDownList>

          <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"
              ControlToValidate="ddlTipoCliente"
              ErrorMessage="El Tipo de Cliente es obligatorio"
              CssClass="text-danger"
              Display="Dynamic"
              ValidationGroup="RegistrarCliente" />
      </div>
      ...
      <div class="row mt-4 col-lg-10">
        <div class="col-12 d-flex justify-content-between">
          <asp:LinkButton ID="btnCancelar" runat="server" CssClass="btn-ghost no-underline" OnClick="btnCancelar_Click" ValidationGroup="">
            Cancelar
          </asp:LinkButton>
          <asp:Button ID="btnRegistrar" runat="server" Text="Registrar" CssClass="btn-main" OnClick="btnRegistrar_Click" ValidationGroup="RegistrarCliente" />
        </div>
      </div>
