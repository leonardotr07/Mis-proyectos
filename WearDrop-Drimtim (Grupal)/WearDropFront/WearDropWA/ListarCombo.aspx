...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container row">
            <div class="row align-items-center">
                ...
                <div class="col text-end p-3">
                    <asp:LinkButton ID="lkRegistrar" CssClass="btn" Style="background-color:  #C5A0A0; color: #FFFFFF; border-color: #73866D; margin-right: 20px" runat="server" OnClick="lkRegistrar_Click" Text="Registrar Promocion" />
                    <asp:LinkButton ID="lkFiltrar" CssClass="btn" Style="background-color:  #C5A0A0; color: #FFFFFF; border-color: #73866D" runat="server" visible="false" OnClick="lkFiltrar_Click" Text="Filtrar" />
                </div>
            </div>
        </div>
   ...
   <asp:LinkButton ID="btnEliminar" runat="server"
    ...
    CommandArgument='<%# Eval("IdPromocion") %>'
    OnClientClick='<%# "return mostrarModal(" + Eval("IdPromocion") + ", \"" + Eval("Nombre") + "\");" %>'
    ToolTip="Eliminar">
    ...
    <div class="modal-content">
        <h3 class="modal-title">¿Está seguro de eliminar esta promocion?</h3>
        <div class="modal-body">
            <div class="info-field">
                <div class="info-label">Nombre de la promocion:</div>
        ...
        <asp:HiddenField ID="hfIdPromocionEliminar" runat="server" />
    </div>
</div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptsContent" runat="server">
    <script type="text/javascript">
    function mostrarModal(idPromocion, nombre) {
        document.getElementById('modalNombre').innerText = nombre;
        document.getElementById('<%= hfIdPromocionEliminar.ClientID %>').value = idPromocion;
