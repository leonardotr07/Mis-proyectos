<%@ Page Title="Modificar Boleta" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="ModificarBoleta.aspx.cs" Inherits="WearDropWA.ModificarBoleta" %>
        ...
        <div class="theme-scope">
            <div class="container">
                ...
                <div class="modal fade" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                El comprobante se modificó correctamente.
                            </div>
                            <div class="modal-footer">
                ...
                <div class="section-container">
                    <asp:UpdatePanel ID="upModificarBoleta" runat="server">
                        <ContentTemplate>
                                ...
                                <div class="two-columns">
                                    ...
                                    <div class="field-block">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvCorrelativo" runat="server" 
                                            ...
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModBoleta" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subsection">
                                <div class="two-columns">
                                    <div class="field-block">
                                        <h3>DNI <span class="required">(*)</span></h3>
                                        <asp:TextBox ID="txtBoletaDNI" runat="server" CssClass="form-control" MaxLength="8"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvDNI" runat="server" 
                                            ControlToValidate="txtBoletaDNI" ErrorMessage="El DNI es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModBoleta" />
                                        <asp:RegularExpressionValidator ID="revDNI" runat="server"
                                            ControlToValidate="txtBoletaDNI" ValidationExpression="^\d{8}$"
                                    ...
                                    <div class="field-block">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvMetodoPago" runat="server" 
                                            ControlToValidate="txtBoletaMetodoPago" ErrorMessage="El método de pago es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModBoleta" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="two-columns">
                                    <div class="field-block">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvFechaBoleta" runat="server" 
                                            ControlToValidate="txtBoletaFecha" ErrorMessage="La fecha es obligatoria" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModBoleta" />
                                    </div>
                                    <div class="field-block">
                                        <h3>Total (S/.) <span class="required">(*)</span></h3>
                                        <asp:TextBox ID="txtBoletaTotal" runat="server" CssClass="form-control" TextMode="Number" placeholder="0.00"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvTotal" runat="server" 
                                            ControlToValidate="txtBoletaTotal" ErrorMessage="El total es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModBoleta" />
                                        <asp:RangeValidator ID="rvTotal" runat="server"
                                            ControlToValidate="txtBoletaTotal" Type="Double" MinimumValue="0.01" MaximumValue="9999999"
                                            ErrorMessage="El total debe ser un número mayor a 0." CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModBoleta" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subsection">
                                <div class="one-column">
                                    <div class="igv-container">
                                        ...
                                        <asp:TextBox ID="txtBoletaIGV" runat="server" CssClass="form-control igv-textbox"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvIGV" runat="server" 
                                            ControlToValidate="txtBoletaIGV" ErrorMessage="IGV obl." 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModBoleta" />
                                        <asp:RangeValidator ID="rvIGV" runat="server"
                                            ControlToValidate="txtBoletaIGV" Type="Double" MinimumValue="0" MaximumValue="100"
                                            ErrorMessage="IGV entre 0-100." CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModBoleta" />
                                    </div>
                                </div>
                            </div>
