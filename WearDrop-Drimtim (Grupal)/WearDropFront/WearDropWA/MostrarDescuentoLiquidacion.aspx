<%@ Page Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="MostrarDescuentoLiquidacion.aspx.cs" Inherits="WearDropWA.MostrarDescuentoLiquidacion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:TextBox ID="txtIdDescuento" runat="server" CssClass="form-control" placeholder="Placeholder text"></asp:TextBox>
        ...
        <!-- Ubicacion -->
        <div class="mb-4">
            <asp:Label ID="lbPorcenatje" runat="server" Text="Porcentaje Liquidacion " CssClass="form-label"></asp:Label>
        ...
        <div class="mb-4">
            <div class="row">
                <div class="col-md-4">
                    <asp:Label ID="lbCondicion" runat="server" Text="Condicion Stock Mínimo " CssClass="form-label"></asp:Label>
