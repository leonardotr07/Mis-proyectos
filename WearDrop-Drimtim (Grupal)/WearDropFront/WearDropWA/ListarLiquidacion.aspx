...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container row">
            <div class="row align-items-center">
                ...
                <div class="col text-end p-3">
                    ...
                    <asp:LinkButton ID="lkFiltrar" CssClass="btn" Style="background-color: #73866D; color: #FFFFFF; border-color: #73866D" runat="server" Visible="false" OnClick="lkFiltrar_Click" Text="Filtrar" />
                </div>
            </div>
        </div>
        <div class="container row mt-4">
            ...
            <asp:GridView ID="gvLiquidaciones" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Porcentaje Liquidacion" DataField="porcentajeLiquidacion"/>
                    <asp:BoundField HeaderText="Condicion Stock Min" DataField="condicionStockMin"/>
   ...
   <asp:LinkButton ID="btnEliminar" runat="server"
    ...
    CommandArgument='<%# Eval("IdDescuento") %>'
    OnClientClick='<%# "return mostrarModal(" + Eval("IdDescuento") + ", \"" + Eval("Nombre") + "\");" %>'
    ToolTip="Eliminar">
    ...
    <div id="modalEliminar" class="modal-overlay">
        <div class="modal-content">
            <h3 class="modal-title">¿Está seguro de eliminar este descuento?</h3>
            <div class="modal-body">
                <div class="info-field">
                    <div class="info-label">Nombre del descuento:</div>
            ...
            <asp:HiddenField ID="hfIdDescuentoEliminar" runat="server" />
        </div>
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptsContent" runat="server">
      <script type="text/javascript">
  function mostrarModal(idDescuento, nombre) {
      document.getElementById('modalNombre').innerText = nombre;
      document.getElementById('<%= hfIdDescuentoEliminar.ClientID %>').value = idDescuento;
