<%@ Page Title="Listar Notas de Débito" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="ListarNotasDeDebito.aspx.cs" Inherits="WearDropWA.ListarNotasDeDebito" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    <style>
        ...
        /* Tema de Comprobantes (Lila para Débito) */
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 p-0">
                            <div class="header-title">
                                <div class="title-section">
                                    ...
                                    <h2>Gestionar Notas de Débito</h2>
                                </div>
                        ...
                        <div class="col text-end p-3">
                            <asp:HyperLink ID="btnIrARegistrar" CssClass="btn-wd" 
                                runat="server" 
                                NavigateUrl="~/RegistrarNotaDeDebito.aspx" 
                                Text="Registrar Nota de Débito" />
                        </div>
                    </div>
                </div>

                <div class="container row mt-3">
                    <asp:GridView ID="gvNotasDeDebito" runat="server" 
                        AutoGenerateColumns="False" 
                        ShowHeaderWhenEmpty="True"
                        EmptyDataText="No hay notas de débito disponibles"
                        CssClass="table table-hover table-striped custom-grid" 
                        AllowPaging="True" 
                        PageSize="10"
                        OnPageIndexChanging="gvNotasDeDebito_PageIndexChanging"
                        GridLines="None">
    ...
    <div id="modalEliminarNotaDebito" class="modal-overlay">
        <div class="modal-content-custom">
            <h3 class="modal-title">¿Está seguro de eliminar esta nota de débito?</h3>
            ...
            <asp:HiddenField ID="hfIdNotaDebitoEliminar" runat="server" />
        </div>
    </div>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptsContent" runat="server">
    <script type="text/javascript">
        function mostrarModalEliminar(idNotaDebito, correlativo, motivo) {
            document.getElementById('modalCorrelativo').innerText = correlativo;
            document.getElementById('modalMotivo').innerText = motivo;
            document.getElementById('<%= hfIdNotaDebitoEliminar.ClientID %>').value = idNotaDebito;
            document.getElementById('modalEliminarNotaDebito').style.display = 'flex';
            return false; // Evita postback hasta confirmar
        }

        function cerrarModalEliminar() {
            document.getElementById('modalEliminarNotaDebito').style.display = 'none';
        }

        // Cerrar modal si se hace clic fuera de él
        window.onclick = function (event) {
            var modal = document.getElementById('modalEliminarNotaDebito');
