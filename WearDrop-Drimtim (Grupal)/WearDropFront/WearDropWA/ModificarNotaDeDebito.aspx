<%@ Page Title="Modificar Nota de Débito" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="ModificarNotaDeDebito.aspx.cs" Inherits="WearDropWA.ModificarNotaDeDebito" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Modificar Nota de Débito
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <style>
        ...
        /* Tema de Comprobantes (Lila) */
        .theme-comprobantes { --tone-1:#D3CBEB; --tone-2:#B4A6D6; --tone-3:#8E83BE; }
        ...
        <div class="theme-scope">
            <div class="container">
                    ...
                    <div class="col-md-7 p-0">
                        <div class="header-title">
                            <div class="title-section">
                                ...
                                <h2>Modificar Nota de Débito</h2>
                            </div>
                ...
                <div class="modal fade" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                La nota de débito se modificó correctamente.
                            </div>
                            <div class="modal-footer">
                ...
                <div class="section-container">
                    <asp:UpdatePanel ID="upModificarND" runat="server">
                        <ContentTemplate>
                                ...
                                <div class="two-columns">
                                    ...
                                    <div class="field-block">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvCorrelativo" runat="server" 
                                            ...
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subsection">
                                <div class="two-columns">
                                    <div class="field-block">
                                        <h3>RUC <span class="required">(*)</span></h3>
                                        <asp:TextBox ID="txtNDRUC" runat="server" CssClass="form-control" MaxLength="11"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvRUC" runat="server" 
                                            ControlToValidate="txtNDRUC" ErrorMessage="El RUC es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                        <asp:RegularExpressionValidator ID="revRUC" runat="server"
                                            ControlToValidate="txtNDRUC" ValidationExpression="^\d{11}$"
                                            ErrorMessage="El RUC debe contener 11 dígitos."
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                    </div>
                                    <div class="field-block">
                                        <h3>Razón Social <span class="required">(*)</span></h3>
                                        <asp:TextBox ID="txtNDRazonSocial" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvRazonSocial" runat="server" 
                                            ControlToValidate="txtNDRazonSocial" ErrorMessage="La razón social es obligatoria" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subsection">
                                <div class="two-columns">
                                    <div class="field-block">
                                        ...
                                        <asp:TextBox ID="txtNDMotivo" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvMotivo" runat="server" 
                                            ControlToValidate="txtNDMotivo" ErrorMessage="El motivo es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                    </div>
                                    <div class="field-block">
                                        <h3>Detalle Modificación <span class="required">(*)</span></h3>
                                        <asp:TextBox ID="txtNDDetalle" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvDetalle" runat="server" 
                                            ControlToValidate="txtNDDetalle" ErrorMessage="El detalle es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subsection">
                                <div class="two-columns">
                                    <div class="field-block">
                                        ...
                                        <asp:TextBox ID="txtNDTotal" runat="server" CssClass="form-control" TextMode="Number" placeholder="0.00"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvTotal" runat="server" 
                                            ControlToValidate="txtNDTotal" ErrorMessage="El total original es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                    </div>
                                    <div class="field-block">
                                        <h3>Valor a Aumentar <span class="required">(*)</span></h3>
                                        <asp:TextBox ID="txtNDValorAumentar" runat="server" CssClass="form-control" TextMode="Number" placeholder="0.00"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvValor" runat="server" 
                                            ControlToValidate="txtNDValorAumentar" ErrorMessage="El valor es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subsection">
                                <div class="two-columns">
                                    <div class="field-block">
                                        ...
                                        <asp:TextBox ID="txtNDNuevoMonto" runat="server" CssClass="form-control" TextMode="Number" placeholder="0.00"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvNuevoMonto" runat="server" 
                                            ControlToValidate="txtNDNuevoMonto" ErrorMessage="El nuevo monto es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                    </div>
                                    <div class="field-block">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvMetodoPago" runat="server" 
                                            ControlToValidate="txtNDMetodoPago" ErrorMessage="El método de pago es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subsection">
                                <div class="two-columns">
                                    <div class="field-block">
                                        ...
                                        <asp:TextBox ID="txtNDFecha" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvFecha" runat="server" 
                                            ControlToValidate="txtNDFecha" ErrorMessage="La fecha es obligatoria" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                    </div>
                                    <div class="field-block">
                                        <h3>ID Prenda <span class="required">(*)</span></h3>
                                        <asp:TextBox ID="txtNDIdPrenda" runat="server" CssClass="form-control" TextMode="Number"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvIdPrenda" runat="server" 
                                            ControlToValidate="txtNDIdPrenda" ErrorMessage="El ID de prenda es obligatorio" 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                    </div>
                                </div>
                            </div>
                             ...
                             <div class="subsection">
                                <div class="one-column">
                                    <div class="igv-container">
                                        ...
                                        <asp:TextBox ID="txtNDIGV" runat="server" CssClass="form-control igv-textbox"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvIGV" runat="server" 
                                            ControlToValidate="txtNDIGV" ErrorMessage="IGV obl." 
                                            CssClass="text-danger" Display="Dynamic" ValidationGroup="vgModND" />
                                    </div>
                                </div>
                            </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptsContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToManager() {
            // Regresa a la lista de notas de débito
