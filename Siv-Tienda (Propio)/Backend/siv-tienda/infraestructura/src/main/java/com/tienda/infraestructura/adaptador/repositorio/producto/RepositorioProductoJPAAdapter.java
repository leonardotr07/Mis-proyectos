...
import com.tienda.infraestructura.adaptador.repositorio.producto.ProductoJpaRepository;
...
public class RepositorioProductoJpaAdapter implements RepositorioProducto{
    ...
    //El actualizar Stock esta ideado para cuando se realizan compras hacia proveedores por ahora.
    @Override
    public void actualizarStock(Long productoId, int cantidad) {
        EntidadProducto entity = jpaRepository.findById(productoId)
